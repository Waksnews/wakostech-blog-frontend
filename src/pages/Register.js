...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        // ✅ FIXED: AUTO-LOGIN AFTER REGISTRATION AND STORE USER DATA
        const loginData = await axiosInstance.post("/user/login", {
          email: inputs.email,
          password: inputs.password,
        });
        ...
        if (loginData.data.success) {
          ...
          localStorage.setItem("email", loginData.data.user.email);
